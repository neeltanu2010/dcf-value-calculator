...
with right:
    ...
    """, unsafe_allow_html=True)
    st.plotly_chart(make_breakdown_chart(base_calc, currency_symbol), use_container_width=True)
    st.markdown("</div>", unsafe_allow_html=True)
...
with tab1:
    ...
    """, unsafe_allow_html=True)
    st.plotly_chart(make_projection_chart(base_calc["projection_df"], currency_symbol), use_container_width=True)
